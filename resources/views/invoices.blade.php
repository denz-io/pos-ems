                            ...
                            <tbody>
                                @foreach($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" href="{{ '/invoices/' . $invoice->id }}" class="btn btn-primary"><i class="fa fa-lg fa-info-circle"> More</i></a>
                                            @if(Auth::user()->status == 'admin')
                                            <a type="button" data-id="{{$invoice->id}}" href="#" class="delete_invoice btn btn-danger"><i class="fa fa-lg fa-trash-o"> Delete</i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
